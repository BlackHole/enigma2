...
SystemInfo["HasSDnomount"] = getMachineBuild() in ("h9") and (False, "none") or getMachineBuild() in ("h9combo", "h9combose", "h9twin", "h9twinse", "h9se", "h11", "multiboxpro", "pulse4k", "pulse4kmini") and (True, "mmcblk0")
