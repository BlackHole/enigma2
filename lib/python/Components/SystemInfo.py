...
SystemInfo["toggleTvRadioButtonEvents"] = SystemInfo["rc_model"] in ("gb0", "gb1", "gb2", "gb3", "gb4", "sf8008", "octagon3", "uclan1") # due to button limitations of the remote control
