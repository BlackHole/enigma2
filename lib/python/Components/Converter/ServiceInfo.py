		...
		if self.type == self.HAS_TELETEXT:
			...
			if audio:
				...
				while idx < n:
					...
					if description in ("AC3", "AC-3", "AC-3 (ATSC A/52)", "AC-3 audio", "A_AC3", "A_AC-3", "A_AC-3 (ATSC A/52)", "A-AC-3 audio", "E-AC-3 audio", "A_EAC3", "DTS", "DTS-HD", "DIGITAL+", "DIGITALPLUS", "AC3+", "E-AC-3"):
